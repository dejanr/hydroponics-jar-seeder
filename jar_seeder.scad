...
cup_depth = 30;                 // [15:1:80] Depth of the seeder cup in mm
...
flange_thickness = 3;           // [2:0.5:6] Flange thickness in mm
...
bottom_hole_spacing = 4.8;      // [2.5:0.1:16] Target center spacing between bottom holes in mm
    ...
    difference() {
        union() {
            ...
            translate([0, 0, cup_depth])
                cylinder(h = flange_thickness, d = flange_outer_diameter);
        }

        translate([0, 0, bottom_thickness])
            cylinder(
                h = cup_depth + flange_thickness - bottom_thickness + epsilon,
